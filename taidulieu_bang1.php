...
<table
border=1><tr><th>ID</th><th>Hoten</th><th>email</th><th>ngaysinh</th><th>chuyennganh</th>
...
$date ->format('d-m-Y'). "</td><td>".$row["major_id"]."</td><td>";
?>
<form method="post" action="xoa.php">
<input type="submit" name="action" value="xoa"/>
<input type="hidden" name="id2" value="<?php echo
$row['id']; ?>"/>
</form>
<?php
echo "</td>";
